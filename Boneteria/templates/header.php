    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark" style="display:flexbox; background-color:lightblue">                            
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <!-- Brand -->
                <a class="navbar-brand" href="/home.php"><img src="img/principal.png" alt="logo" width="125px" height="60px"></a>
            ...
            <div class="collapse navbar-collapse " id="collapsibleNavbar">
                <ul class="navbar-nav mr-auto ">
                    <li class="nav-item active">
                        <a class="nav-link" id="btnInicio" href="/home.php">Ubicaciones</a>
                    </li>
                    <li class="nav-item active">
                        <a id="btnArticulos" class="nav-link" href="/articulos.php">Ofertas</a>
                    </li>          
                    <li class="nav-item dropdown active">                    
                        ...
                        <div class="dropdown-menu dropdown-menu-sm-right" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="/destino.php">Dama</a>
                            <a class="dropdown-item" href="/paso.php">Caballero</a>
                            <a class="dropdown-item" href="/paso.php">Niño</a> 
                            <a class="dropdown-item" href="/paso.php">Niña</a> 
                        </div>                    
                    </li>          
                </ul>
